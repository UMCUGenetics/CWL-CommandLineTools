...
inputs:
  ...
  - id: alignSJstitchMismatchNmax
    ...
    doc: >
      ...
      4*int>=0: maximum number of mismatches for stitching of the splice
      junctions (-1: no limit).
  ...
  - id: bamRemoveDuplicatesType
    ...
    doc: >
      ...
      string: mark duplicates in the BAM file, for now only works with sorted
      BAM feeded with inputBAMfile

      -               ... no duplicate removal/marking

      UniqueIdentical ... mark all multimappers, and duplicate unique mappers.
  ...
  - id: chimFilter
    ...
    doc: >
      ...
      banGenomicN ... Ns are not allowed in the genome sequence around the
      chimeric junction
  ...
  - id: chimScoreSeparation
    ...
    doc: >
      int>=0: minimum difference (separation) between the best chimeric score
      and
  ...
  - id: clip3pAdapterSeq
    ...
    doc: >
      string(s): adapter sequences to clip from 3p of each mate.  If one value
      is
  ...
  - id: genomeLoad
    ...
    doc: >
      ...
      LoadAndKeep     ... load genome into shared and keep it in memory after
      run

      LoadAndRemove   ... load genome into shared but remove it after run

      LoadAndExit     ... load genome into shared memory and exit, keeping the
      genome in memory for future runs

      Remove          ... do not map anything, just remove loaded genome from
      memory

      NoSharedMemory  ... do not use shared memory, each job will have its own
      private copy of the genome
  - id: genomeSAindexNbases
    ...
    doc: >
      int: length (bases) of the SA pre-indexing string. Typically between 10
      and
  ...
  - id: limitBAMsortRAM
    ...
    doc: >
      int>=0: maximum available RAM for sorting BAM. If =0, it will be set to
      the
  ...
  - id: outFilterIntronMotifs
    ...
    doc: >
      ...
      RemoveNoncanonicalUnannotated  ... filter out alignments that contain
      non-canonical unannotated junctions when using annotated splice junctions
      database. The annotated non-canonical junctions will be kept.
  - id: outFilterMatchNmin
    ...
    doc: >
      ...
      int: alignment will be output only if the number of matched bases is
  ...
  - id: outMultimapperOrder
    ...
    doc: >
      ...
      Random              ... random order of alignments for each multi-mapper.
      Read mates (pairs) are always adjacent, all alignment for each read stay
  ...
  - id: outSAMattrRGline
    ...
    doc: >
      ...
      xxx will be added as RG tag to each output alignment. Any spaces in the
      tag values have to be double quoted.
  ...
  - id: outSAMattributes
    ...
    doc: >
      ...
      string: a string of desired SAM attributes, in the order desired for the
      output SAM
  ...
  - id: outSAMfilter
    ...
    doc: >
      ...
      KeepOnlyAddedReferences ... only keep the reads for which all alignments
      are to the extra reference sequences added with --genomeFastaFiles at the
      mapping stage.
  - id: outSAMflagAND
    type: int?
    inputBinding:
  ...
  - id: outSAMmultNmax
    ...
    doc: >
      ...
      the SAM/BAM files. -1 ... all alignments (up to --outFilterMultimapNmax)
      will be output
  - id: outSAMorder
    type: string?
    inputBinding:
  ...
  - id: outSAMprimaryFlag
    ...
    doc: >
      ...
      string: which alignments are considered primary - all others will be
      marked with 0x100 bit in the FLAG
  ...
  - id: outSAMreadID
    ...
    doc: >
      ...
      Standard ... first word (until space) from the FASTx read ID line,
      removing /1,/2 from the end
  ...
  - id: outSAMunmapped
    ...
    doc: >
      ...
      Within ... output unmapped reads within the main SAM file (i.e.
      Aligned.out.sam)
  - id: outSJfilterCountTotalMin
    ...
    doc: >
      ...
      4 integers: minimum total (multi-mapping+unique) read count per junction
      for: (1) non-canonical motifs, (2) GT/AG and CT/AC motif, (3) GC/AG and
      CT/GC motif, (4) AT/AC and GT/AT motif. -1 means no output for that motif

      Junctions are output if one of outSJfilterCountUniqueMin OR
      outSJfilterCountTotalMin conditions are satisfied
  ...
  - id: outSJfilterCountUniqueMin
    ...
    doc: >
      ...
      4 integers: minimum uniquely mapping read count per junction for: (1)
  ...
  - id: outSJfilterIntronMaxVsReadN
    ...
    doc: >
      ...
      reads: <=100000b, by 3 reads: <=200000. by >=4 reads any gap
      <=alignIntronMax
  ...
  - id: outSJfilterOverhangMin
    ...
    doc: >
      ...
      4 integers:    minimum overhang length for splice junctions on both sides
      for: (1) non-canonical motifs, (2) GT/AG and CT/AC motif, (3) GC/AG and
      CT/GC motif, (4) AT/AC and GT/AT motif. -1 means no output for that motif
  ...
  - default: Log
    ...
    doc: >
      ...
      SAM                    ... alignments in SAM format (which normally are
      output to Aligned.out.sam file), normal standard output will go into
      Log.std.out

      BAM_Unsorted           ... alignments in BAM format, unsorted. Requires
      --outSAMtype BAM Unsorted

      BAM_SortedByCoordinate ... alignments in BAM format, unsorted. Requires
      --outSAMtype BAM SortedByCoordinate

      BAM_Quant              ... alignments to transcriptome in BAM format,
      unsorted. Requires --quantMode TranscriptomeSAM
  - id: outTmpDir
    type: string?
    inputBinding:
      position: 1
  ...
  - id: outWigType
    ...
    doc: >
      ...
      read1_5p   ... signal from only 5' of the 1st read, useful for
      CAGE/RAMPAGE etc
  ...
  - id: quantMode
    ...
    doc: >
      ...
      TranscriptomeSAM ... output SAM/BAM alignments to transcriptome into a
      separate file
  ...
  - id: quantTranscriptomeBan
    ...
    doc: >
      ...
      IndelSoftclipSingleend  ... prohibit indels, soft clipping and single-end
      alignments - compatible with RSEM
  ...
  - default: alignReads
    ...
    doc: >
      ...
      inputAlignmentsFromBAM ... input alignments from BAM. Presently only works
      with --outWigType and --bamRemoveDuplicates.
  - id: runRNGseed
    type: int?
    inputBinding:
      position: 1
  ...
  - id: sjdbFileChrStartEnd
    ...
    doc: >
      ...
      <tab> end <tab> strand) for the splice junction introns. Multiple files
      can be supplied wand will be concatenated.
  - id: sjdbGTFchrPrefix
    type: string?
    inputBinding:
      position: 1
  ...
  - id: sjdbGTFtagExonParentGene
    ...
    doc: >
      ...
      string: tag name to be used as exons' gene-parents (default "gene_id"
      works for GTF files)
  ...
  - id: sjdbInsertSave
    ...
    doc: >
      ...
      string: which files to save when sjdb junctions are inserted on the fly at
      the mapping step

      Basic ... only small junction / transcript files

      All   ... all files including big Genome, SA and SAindex - this will
      create a complete genome directory
  - id: sjdbOverhang
    type: int?
    inputBinding:
      position: 1
  ...
  - id: twopass1readsN
    ...
    doc: >
      int: number of reads to process for the 1st step. Use very large number
      (or
  ...
  - id: twopassMode
    ...
    doc: >
      ...
      Basic       ... basic 2-pass mapping, with all 1st pass junctions inserted
